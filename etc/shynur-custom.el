...
(defmacro shynur/c-appdata/ (base &optional suffix seq-type &rest forms)
  "将“‘shynur/c-appdata/’ BASE SUFFIX”赋给 BASE; 确保父目录存在.
SUFFIX 可能的值为:
...
若 FORMS 非-nil 则忽略 SUFFIX 和 SEQ-TYPE, 执行 FORMS 就像在‘progn’中, 结果赋给 BASE.
