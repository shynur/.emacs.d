...
Type \"%s\" to exit."
         emacs-version
         (format-time-string "%b %e %Y, %T %z" emacs-build-time)
...
;;   exit REPL.  It would be nice to recognize character ‘^C’.

...
;; TODO#2:
;;      Anyway to show error messages and backtraces, WITHOUT exiting
;;   the REPL?
